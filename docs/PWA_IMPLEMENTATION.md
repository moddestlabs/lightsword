...
2. **Service Worker** (Auto-generated by Flutter)
...
- **Storage limit** - 50MB, cleared after 7 days inactivity
...
6. Navigate between screens - all cached
...
- **Check cache** - Should show cached resources
